...
silent only
cd ~/www/deejay/deejay
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +9 ~/www/jquery-ui-1.10.2/index.html
badd +0 ~/www/jquery-ui-1.10.2/prac.html
badd +0 ~/www/jquery-ui-1.10.2/js/my.js
badd +0 ~/www/jquery-ui-1.10.2/css/my.css
badd +0 ~/www/deejay/blog/urls.py
badd +0 ~/www/deejay/blog/models.py
badd +0 ~/www/deejay/blog/views.py
badd +0 ~/www/deejay/templates/blog/header.html
badd +0 ~/www/deejay/templates/blog/single.html
badd +120 ~/www/deejay/deejay/settings.py
badd +0 ~/www/deejay/deejay/urls.py
args ~/www/jquery-ui-1.10.2/index.html
edit ~/www/deejay/deejay/urls.py
...
argglobal
enew
file ~/www/jquery-ui-1.10.2/NERD_tree_9
let s:cpo_save=&cpo
set cpo&vim
...
exe 'vert 1resize ' . ((&columns * 31 + 76) / 153)
exe 'vert 2resize ' . ((&columns * 121 + 76) / 153)
tabedit ~/www/jquery-ui-1.10.2/prac.html
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
15
normal! 04l
tabedit ~/www/jquery-ui-1.10.2/css/my.css
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
5
normal! 013l
tabedit ~/www/jquery-ui-1.10.2/js/my.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
1
normal! 0
tabedit ~/www/deejay/blog/urls.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
1
normal! 0
tabedit ~/www/deejay/templates/blog/header.html
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
argglobal
enew
file ~/www/deejay/blog/NERD_tree_7
let s:cpo_save=&cpo
set cpo&vim
nnoremap <buffer> <silent> <NL> :call nerdtree#invokeKeyMap("<C-j>")
nnoremap <buffer> <silent>  :call nerdtree#invokeKeyMap("<C-k>")
...
37
normal! 02l
tabedit ~/www/deejay/blog/models.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 21 - ((20 * winheight(0) + 38) / 76)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
21
normal! 0
tabedit ~/www/deejay/blog/views.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
14
normal! 033l
tabedit ~/www/deejay/deejay/settings.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 120 - ((37 * winheight(0) + 38) / 76)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
120
