...
imap <S-CR> \q
noremap! <C-1> :q!
imap <F8> : call JavaScriptLint()
noremap! <F6> "bp
noremap! <F5> "ap
imap <F2> <Plug>RStart
inoremap <silent> <SNR>40_yrrecord =YRRecord3()
...
noremap <silent> <F4> :set hlsearch! hlsearch?
nnoremap <silent> <F11> :YRShow
map <C-F12> :!ctags -R --sort=yes --c++-kinds=+p --fields=+iaS --extra=+q .
nnoremap <C-Left> :bprevious
nnoremap <C-Right> :bnext
nnoremap <silent> <C-Tab> :execute 'silent! tabmove ' . tabpagenr()
nnoremap <silent> <C-S-Tab> :execute 'silent! tabmove ' . (tabpagenr()-2)
nnoremap <C-1> :q!
nmap <F8> : call JavaScriptLint()
nnoremap <F9> :make
nnoremap <F6> "bp
nnoremap <F5> "ap
noremap <silent> <F10> :set hlsearch! hlsearch?
vmap <F2> <Plug>RStart
nmap <F2> <Plug>RStart
snoremap <Left> bi
snoremap <Right> a
...
nnoremap <silent> <SNR>40_yrrecord :call YRRecord3()
map <S-Insert> <MiddleMouse>
noremap!  :tabprevious
...
set mouse=a
set pastetoggle=<F2>
set path=.,/usr/include,/usr/include/qt4/QtGui
...
set noswapfile
set tabstop=4
set tags=./tags;/,~/.vim/tags/cpp,~/.vim/tags/gl,~/.vim/tags/sdl,~/.vim/tags/qt4
...
silent only
cd ~/www/deejay/editor/static/editor/css
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 ~/www/deejay/editor/static/editor/main.html
badd +1 ~/www/deejay/editor/static/editor/js/editor.js
badd +0 ~/www/deejay/templates/editor/main.html
badd +0 ~/www/deejay/editor/static/editor/css/editor.css
args ~/www/deejay/editor/static/editor/main.html
edit ~/www/deejay/templates/editor/main.html
...
29
normal! 03l
tabedit ~/www/deejay/editor/static/editor/js/editor.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 60 - ((28 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
60
normal! 04l
tabedit ~/www/deejay/editor/static/editor/css/editor.css
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 31 + 76) / 153)
exe 'vert 2resize ' . ((&columns * 121 + 76) / 153)
argglobal
enew
file ~/www/deejay/editor/static/editor/js/NERD_tree_2
let s:cpo_save=&cpo
set cpo&vim
