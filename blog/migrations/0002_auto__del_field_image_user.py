...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'blog_image', 'user_id')


    def backwards(self, orm):
        # Adding field 'Image.user'
        db.add_column(u'blog_image', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='docsmart', to=orm['auth.User']),
                      keep_default=False)
